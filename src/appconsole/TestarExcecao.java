...
public class TestarExcecao {
	...
	public static void main (String[] args) {
		...
		try {
			// Fachada.criarCorrentista("123", "Luiz", "0806");
			// Fachada.criarCorrentista("100", "joao", "0806");
			// Fachada.criarCorrentista("50", "lucas", "0806");
			// Fachada.criarCorrentista("23", "mateus", "0806");

			// Fachada.criarConta("123");
			// Fachada.criarConta("100");

			// Fachada.removerCorrentistaConta("123", 1);
			// Fachada.inserirCorrentistaConta("123", 2);
			// Fachada.inserirCorrentistaConta("100", 1);

			// Fachada.apagarConta(1);
			// Fachada.criarConta("123");
			Fachada.criarContaEspecial("50", 100);
